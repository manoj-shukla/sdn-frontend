    ...
    return (
        <div className="max-w-[1600px] mx-auto space-y-8 p-4 bg-[#f8fafc] min-h-screen">
            <div className="flex flex-col gap-2">
                ...
                <p className="text-muted-foreground ml-11">Archive of all your past sourcing events and feedback.</p>
            </div>
            ...
            <Card className="border-2 border-dashed border-slate-200 bg-white/50">
                <CardContent className="flex flex-col items-center justify-center py-24 text-center">
                    ...
                    <p className="text-slate-500 max-w-md">
                        The Bid History archive is being developed. It will allow you to analyze your performance and trends across multiple procurement cycles.
                    </p>
                </CardContent>
            </Card>
        </div>
