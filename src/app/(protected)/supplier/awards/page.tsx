        ...
        <div className="max-w-[1600px] mx-auto space-y-8 p-4 bg-[#f8fafc] min-h-screen">
            <div className="flex flex-col gap-2">
                <div className="flex items-center gap-3">
                    ...
                    <h1 className="text-3xl font-extrabold text-[#1e293b] tracking-tight">Awards</h1>
                </div>
                <p className="text-muted-foreground ml-11">View your won contracts and official award notifications.</p>
            </div>
            ...
            <Card className="border-2 border-dashed border-slate-200 bg-white/50">
                <CardContent className="flex flex-col items-center justify-center py-24 text-center">
                    ...
                    <p className="text-slate-500 max-w-md">
                        The Awards notification portal is currently being built. You will be able to review and acknowledge your procurement wins here.
                    </p>
                </CardContent>
            </Card>
        </div>
