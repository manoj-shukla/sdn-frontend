    ...
    return (
        <div className="max-w-[1600px] mx-auto space-y-8 p-4 bg-[#f8fafc] min-h-screen">
            <div className="flex flex-col gap-2">
                ...
                <p className="text-muted-foreground ml-11">Finalize bid selections and issue award notifications.</p>
            </div>
            ...
            <Card className="border-2 border-dashed border-slate-200 bg-white/50">
                <CardContent className="flex flex-col items-center justify-center py-24 text-center">
                    ...
                    <p className="text-slate-500 max-w-md">
                        The Awards module is currently being built. You will soon be able to formalize your procurement decisions and notify winners here.
                    </p>
                </CardContent>
            </Card>
        </div>
